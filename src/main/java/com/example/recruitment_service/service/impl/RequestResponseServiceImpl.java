...
import com.example.recruitment_service.common.Common;
import com.example.recruitment_service.common.Constants;
import com.example.recruitment_service.model.RequestResponse;
import com.example.recruitment_service.repository.mongo.RequestResponseRepository;
...
public class RequestResponseServiceImpl implements RequestResponseService {
    ...
    public void logRequest(HttpServletRequest httpServletRequest, Object body) {
        ...
        if (httpServletRequest.getAttribute(Constants.REQUEST_RESPONSE_ATTRIBUTE) == null) {
            String uuidRequest = Common.getUUID();
